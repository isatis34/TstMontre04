...
public class PatientAdapter extends BaseExpandableListAdapter {
	...
	public Region.FRXX.ClinicomLink.cli.Pat.ClassListofPatients ClassPatients;
	...
	public PatientAdapter(Context context, Region.FRXX.ClinicomLink.cli.Pat.ClassListofPatients patients) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = inflater.inflate( R.layout.line_def_lv_patients, null);
		}
	...
	public Region.FRXX.ClinicomLink.cli.Pat.ClassPatient getPatient(int index) {
...
*/
	...
	*/
	public void setPatients(Region.FRXX.ClinicomLink.cli.Pat.ClassListofPatients patients) {
		this.ClassPatients = patients;
		this.notifyDataSetChanged();
	}
